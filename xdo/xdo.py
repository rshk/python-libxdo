...
libxdo.xdo_move_mouse_relative_to_window.argtypes = (
    POINTER(xdo_t), c_void_p, c_int, c_int)
...
libxdo.xdo_move_mouse_relative.argtypes = ()
...
libxdo.xdo_mouse_down.argtypes = ()
...
#                            int *screen_num);
libxdo.xdo_get_mouse_location.argtypes = ()
...
#                                  int origin_y);
libxdo.xdo_wait_for_mouse_move_from.argtypes = ()
...
libxdo.xdo_wait_for_mouse_move_to.argtypes = ()
...
libxdo.xdo_click_window.argtypes = ()
...
libxdo.xdo_enter_text_window.argtypes = (
    POINTER(xdo_t), c_void_p, c_char_p, c_int)
